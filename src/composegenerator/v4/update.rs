...
pub async fn get_hash(
    ...
    println!("Pulling {}...", container.clone());
    let pull = docker
        .create_image(
            Some(CreateImageOptions {
                from_image: container.clone(),
                ..Default::default()
            }),
            None,
            None,
...
pub async fn update_container(container: &mut Container, to_version: &String, docker: &Docker) -> Result<(), bollard::errors::Error> {
